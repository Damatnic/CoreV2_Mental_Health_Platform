...
export const SendIcon = () => <DynamicIcon name="share" />;
export const AICompanionIcon = () => <DynamicIcon name="brain" />;
...
export const RefreshIcon = () => <DynamicIcon name="refresh" />;
...
export const LockIcon = () => <DynamicIcon name="lock" />;
